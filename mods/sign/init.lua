...
minetest.register_node("sign:radioactive", {
	...
	inventory_image = "radioactive.png",
	paramtype = "light",
...
minetest.register_node("sign:waterobstructions", {
	...
	inventory_image = "waterobstructions.png",
	paramtype = "light",
	paramtype2 = "wallmounted",
	sunlight_propagates = true,
	walkable = false,
...
minetest.register_node("sign:electricity", {
	...
	inventory_image = "electricity.png",
    drawtype = "signlike",
	paramtype = "light",
	paramtype2 = "wallmounted",
	sunlight_propagates = true,
...
minetest.register_node("sign:carcinogen", {
	...
	inventory_image = "carcinogen.png",
	paramtype = "light",
	paramtype2 = "wallmounted",
	sunlight_propagates = true,
	walkable = false,
...
minetest.register_node("sign:fallobject", {
	...
	inventory_image = "fallobject.png",
	paramtype = "light",
	paramtype2 = "wallmounted",
	sunlight_propagates = true,
	walkable = false,
