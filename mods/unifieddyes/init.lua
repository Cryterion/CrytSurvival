...
minetest.register_craftitem(":dye:lime", {
	...
	groups = { dye=1, excolor_lime=1, unicolor_lime=1, not_in_creative_inventory=0 }
})
...
minetest.register_craftitem(":dye:aqua", {
	...
	groups = { dye=1, excolor_aqua=1, unicolor_aqua=1, not_in_creative_inventory=0 }
})
...
minetest.register_craftitem(":dye:skyblue", {
	...
	groups = { dye=1, excolor_sky_blue=1, unicolor_sky_blue=1, not_in_creative_inventory=0 }
})
...
minetest.register_craftitem(":dye:redviolet", {
	...
	groups = { dye=1, excolor_red_violet=1, unicolor_red_violet=1, not_in_creative_inventory=0 }
})
...
minetest.register_craftitem(":dye:light_grey", {
	...
	groups = { dye=1, excolor_lightgrey=1, unicolor_light_grey=1, not_in_creative_inventory=0 }
})
...
for i = 1, 12 do
	...
	minetest.register_craftitem("unifieddyes:dark_" .. hue .. "_s50", {
		...
		groups = { dye=1, ["unicolor_dark_"..hue.."_s50"]=1, not_in_creative_inventory=0 }
	})
	...
	if hue ~= "green" then
		minetest.register_craftitem("unifieddyes:dark_" .. hue, {
			...
			groups = { dye=1, ["unicolor_dark_"..hue]=1, not_in_creative_inventory=0 }
		})
	end
	...
	minetest.register_craftitem("unifieddyes:medium_" .. hue .. "_s50", {
		...
		groups = { dye=1, ["unicolor_medium_"..hue.."_s50"]=1, not_in_creative_inventory=0 }
	})
	...
	minetest.register_craftitem("unifieddyes:medium_" .. hue, {
		...
		groups = { dye=1, ["unicolor_medium_"..hue]=1, not_in_creative_inventory=0 }
	})
	...
	minetest.register_craftitem("unifieddyes:" .. hue .. "_s50", {
		...
		groups = { dye=1, ["unicolor_"..hue.."_s50"]=1, not_in_creative_inventory=0 }
	})
	...
	if hue ~= "red" then
		minetest.register_craftitem("unifieddyes:light_" .. hue, {
			...
			groups = { dye=1, ["unicolor_light_"..hue]=1, not_in_creative_inventory=0 }
		})
	end
